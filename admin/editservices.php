            ...
            <div class="card custom-card mt-2">
                ...
                <form method="post" action="functions/functions.php" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="description" id="title" value="<?php echo $description ?>" placeholder="enter the description" required>
                        </div>

                        <div class="mb-3">
                            <input type="hidden" name="old_img" value="<?php echo $img ?>">
                            <input type="hidden" name="id" value="<?php echo $id ?>">
                            <button type="submit" class="btn btn-success float-end" name="update_services" style="background-color:#e9b819;">SUBMIT</button>
                        </div>
                    </form>
