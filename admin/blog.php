    ...
    <div class="col-lg-10 wrapper">
        <div class="card custom-card-2">
          <div class="card-body p-3 d-flex align-items-center justify-content-between">
            <h5 class="mb-0 fw-bold">BLOG</h5>
            <a href="add_blog.php" class="btn btn-success" style="background-color: #FEB700;">Add Blog</a>
          </div>
        </div>
                  ...
                  <div class="card-body p-2 text-center">
                    ...
                    <div class="d-flex justify-content-center">
                      <form method="post" action="editblog.php">
                        ...
                        <button type="submit" name="update_blog" class="btn btn-primary me-2">Update</button>
                      </form>
